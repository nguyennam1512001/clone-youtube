...
import { CommentBold, DisLikeBold, LikeBold, Menu, ShareBold } from '../../../public/assets/icons';
...
function Action({ item }) {
  ...
  return (
    <div className={clsx(style.action_container)}>
      <div className={clsx('flex-align-center flex-column', style.actions)}>
        <div className={clsx(style.likes, style.actions_btn)}>
          <div className={clsx(style.btn_shape)}>
            <div
              className={clsx('flex-center simple-endpoint', style.icon_shape, { [style.active]: likeActive })}
            ...
            <div className={clsx(style.text, 'text-one-line')}>{convertViewCount(item.statistics.likeCount)}</div>
          </div>
          <div className={clsx(style.btn_shape)}>
            <div
              className={clsx('flex-center simple-endpoint', style.icon_shape, { [style.active]: dislikeActive })}
              data-tooltip-id="short-action-icon"
            ...
            <div className={clsx(style.text, 'text-one-line')}>Không thích</div>
          </div>
        </div>
        <div className={clsx(style.comments_btn, style.actions_btn)}>
          <div className={clsx(style.btn_shape)}>
            ...
            <div className={clsx(style.text, 'text-one-line')}>{convertViewCount(item.statistics.commentCount)}</div>
          </div>
        </div>
        <div className={clsx(style.share_btn, style.actions_btn)}>
          <div className={clsx(style.btn_shape)}>
            ...
            <div className={clsx(style.text, 'text-one-line')}></div>
          </div>
        </div>
